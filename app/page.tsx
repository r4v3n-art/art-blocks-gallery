      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            <p className="text-gray-600 dark:text-gray-400 font-light text-lg">or jump into a featured collection</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {featuredCollections.map((collection) => (
              <div key={collection.name} className="bg-white dark:bg-[#2d2d2e] border border-gray-200 dark:border-gray-700 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-gray-900/20 transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <a 
                      ...
                      className="text-xs text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 underline transition-colors"
                    >
                      View on Art Blocks
                    </a>
                  </div>
                  <Button 
                    ...
                    className="w-full inline-flex items-center justify-center gap-2 bg-gray-900 hover:bg-gray-800 dark:bg-gray-100 dark:hover:bg-gray-200 dark:text-gray-900 text-white dark:text-gray-900 rounded-none font-light"
                  >
        ...
        <div className="text-center mt-20 space-y-4">
          <div className="flex items-center justify-center gap-3">
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-3 py-2 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-sm font-light rounded-none hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors"
            >

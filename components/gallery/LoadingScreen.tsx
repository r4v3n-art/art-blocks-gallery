      ...
      <div className="text-gray-900 text-center max-w-md">
        ...
        {showDetailedProgress && loadingProgress.total > 0 ? (
          <div className="space-y-4">
            ...
            {loadingProgress.loaded >= 100 && !canStartGallery && onStartNow && (
              <div className="pt-4 border-t border-gray-200">
                ...
                <button
                  onClick={onStartNow}
                  className="bg-gray-900 hover:bg-gray-800 text-white px-6 py-2 font-light transition-colors"
                >
                  Start Now
                </button>
              </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm font-light text-gray-600">Preparing gallery...</p>
          </div>
        )}
      </div>
    </div>
